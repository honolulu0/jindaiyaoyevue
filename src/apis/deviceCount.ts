...
const convertToSmartDeviceVO = (dto: DeviceCountDTO): DeviceCountVO[] => {
  ...
  const deviceMapping: Record<string, { title: string, img: string }> = {
    '视频监控': { title: '监控', img: 'parkFacilities/监控icon.png' },
    ...
    '车辆道闸': { title: '车牌识别', img: 'parkFacilities/车牌识别icon.png' },
    '智能井盖': { title: '智慧井盖', img: 'parkFacilities/智慧井盖icon.png' },
    '智能水节点': { title: '水节点监测', img: 'parkFacilities/水节点监测icon.png' },
    '水表': { title: '水表数据', img: 'parkFacilities/水表数据icon.png' },
    '智能配电柜': { title: '配电房状态', img: 'parkFacilities/配电房状态icon.png' },
    '电表': { title: '电表数据', img: 'parkFacilities/电表数据icon.png' },
    '停车场': { title: '车位识别', img: 'parkFacilities/车位识别icon.png' }
  }

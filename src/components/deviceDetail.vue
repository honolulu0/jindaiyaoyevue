<template>
	<div class="error-detail">
		...
		<div class="device-info">
			...
			<div class="device-info-content">
				<div>设备状态:</div>
				<div class="device-name" :style="{ color: deviceDetail.status === '异常' ? '#FF0000' : '#00FF00' }">
					{{ deviceDetail.status }}
				</div>
				<div>设备位置:</div>
          ...
          /> -->
			...
			<TitleComponent titleText="监控视频" style="margin-top: 10px" v-if="deviceDetail.url" />
			<div class="device-realtime-status" v-if="deviceDetail.url">

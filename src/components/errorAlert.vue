		...
		<div class="list_content">
			<div class="list_header">
				<div class="list_content_item title_row">
					<div v-for="(item, key) in titleMap" :key="key" class="col title_col">
						<div :class="{
			...
			<div class="list_body">
				<div class="list_body_content" v-for="(item, index) in list" :key="index"
					@click="handleItemClick(item.raw)">
					<div class="list_content_item data_row">
						<div v-for="(value, key) in getDisplayData(item)" :key="key" class="col"
							:class="{ error: item.row4 === '未处理' && key === 'row2' }">
							<div v-if="key === 'row1'" :class="{
                  list_body_icon: true,

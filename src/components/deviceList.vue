<template>
	<div class="device_list" :style="{ top: top + 'px', left: left + 'px', height: height + 'px' }">
		...
		<div class="device_list_content">
			...
			<div class="device_list_body">
				<div v-for="(item, index) in deviceList" :key="index" class="device_list_content_item data_row"
					:class="{ error: hasError(item) }" @click="handleItemClick(item.raw)">

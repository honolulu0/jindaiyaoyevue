  ...
  <AspectRatioContainer>
    ...
    <Transition name="fade">
      <div v-if="isShow">
        ...
        <slot></slot>
        <template
          v-if="router.currentRoute.value.path !== '/parkEnterpriseDetail'"
        >
          <div
    ...
    <div
      class="button-house-pic"
      @click="handleHousePic"
    >
      按钮
    </div>
...
<script setup lang="ts">
  ...
  const housePicList = ref<HousePic[]>([]);

  function handleHousePic() {
    console.log("点击户型图");
  }
  ...
  onMounted(async () => {
    ...
    housePicList.value = hpList;
    console.log("户型图列表", housePicList.value);
    try {
